-- ============================================================================
-- 10_ALERTS_NOTIFICATIONS.SQL — Alerts for Grid Integration
-- ============================================================================
USE DATABASE GRID_INTEGRATION;
USE SCHEMA APP;

-- Notification integration (email)
CREATE OR REPLACE NOTIFICATION INTEGRATION aws_vietnam_renewable_grid_EMAIL_INT
  TYPE = EMAIL
  ENABLED = TRUE
...
CREATE OR REPLACE ALERT APP.PERFORMANCE_ALERT
  WAREHOUSE = GRID_WH
  SCHEDULE = '5 MINUTE'
  COMMENT = 'Grid Integration performance below threshold'
IF (EXISTS (
...
THEN
  CALL SYSTEM$SEND_EMAIL(
    'aws_vietnam_renewable_grid_EMAIL_INT',
    '<YOUR_EMAIL>',
    '[ALERT] Grid Integration: Grid Integration performance below threshold',
    'Grid Integration performance below threshold'
  );
...
THEN
  CALL SYSTEM$SEND_EMAIL(
    'aws_vietnam_renewable_grid_EMAIL_INT',
    '<YOUR_EMAIL>',
    '[ALERT] Grid Integration: Anomalous pattern detected',
